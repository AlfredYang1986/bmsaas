    ...
    queryMultiObjects(param,callback) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (result == null) {
                    that.set('reserveType', []);
                    that.set('reserveTypeToday', []);
                    that.set('reserveTypeAmount', 0);
                    that.set('reserveTypeTodayAmount', 0);
    
                    that.set('amount', 0);
                    that.set('reserved', []);
                    that.set('preAmount', 0);
                    that.set('preRegistered', []);
    
                    that.set('preRegister', []);
                    that.set('preRegisterToday', []);
                    that.set('preRegisterAmount', 0);
                    that.set('preRegisterTodayAmount', 0)
