...
export default Route.extend({
  ...
  setupController(controller, model) {
    ...
    if (model.stud != null) {
      ...
      // controller.set('par_name', model.stud.Guardians.get('name'));
      // controller.set('par_nickname', model.stud.Guardians.get('nickname'));
      // controller.set('par_rs', model.stud.Guardians.get('rs'));
      // controller.set('par_contact', model.stud.Guardians.get('contact'));
      // controller.set('par_wechat', model.stud.Guardians.get('wechat'));
      // controller.set('par_address', model.stud.Guardians.get('address'));
